...
//             body: message,
//         };
//         client.messages.create(smsOptions).then(message => console.log("Successfully Sent")).catch(err => console.log(err));
//     });
// };
...
//     return payload;
// }
// const  sendSMSMessages =  async (payload) => {
//     if (payload.dialCode && payload.phoneNo && payload.messaage){
//         console.log("payload.message",payload.dialCode,payload.phoneNo, payload.message)
//         await sendSMS(payload.dialCode, payload.dialCode,payload.phoneNo, payload.message)
